    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
               ...
               //required ("includes/funcions.php");
               //required_once ("includes/funcions.php");
               
               $numero = 88;
               $numero2 = 9;
               $ano = 1988;
               $numero3 = 19591;
               $texto = "Hola que tal estas? Yo bien y tu? Bien tambien. Un saludo";
               
               echo par($numero) ? "$numero É par" : "$numero É impar";
               
               echo "<br>" . incremento($numero);
               
               echo "<br>" . incremento2($numero);
               
               echo "<br>" . producto($numero, $numero2);
               ...
               echo "<br>" . nomeMes($numero2);
               
               echo "<br>" . iva($numero, $numero2);
               
               echo "<br>" . media($numero, $numero2);
               
               echo "<br>" . esBisiesto($ano) . "<br>";
               
               echo esCapicua($numero3) ? "El $numero3 es Capicua" : "El $numero3 NO es Capicua";
               
               echo "<br>";
               fibonacci($numero2);
               
               echo "<br>" . exercicio15($numero, $numero2, $numero3, $ano);
               
               echo "<br>";
               print_r(stats($texto));
               
               echo "<br>" . exercicio17($numero, $numero2, $numero3, $ano);
               
               echo "<br>" . exercicio18([$numero, $numero2, $numero3, $ano], $m) . " $m";
