...
require_once("models/ValoracionTroncos.php");
require_once("models/ValoracionTroncosDAO.php");
require_once("models/LoteTroncos.php");
require_once("models/LoteTroncosDAO.php");
?>
<!DOCTYPE html>
<html lang="es">
	<head>
        ...
        <meta name="description" content="Plantilla básica para DAW">
