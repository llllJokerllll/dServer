		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                ...
                if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == "1") {
                    ...
                    //$baseOk = false;
                    //$alturaOk = false;
                    if (filter_var($base, FILTER_VALIDATE_INT, ["options" => ["min_range" => 3, "max_range" => 99] ]) === false) {
                        $error .= "<br>Base non é un número válido";
                    }
                    
                    if (filter_var($altura, FILTER_VALIDATE_INT, ["options" => ["min_range" => 3, "max_range" => 99] ]) === false) {
                ...
                ?>
                    <form class="<?= $error != "" ? 'was-validated':''?>" action="<?= $_SERVER["PHP_SELF"]?>" method="get">
                    	<div class="form-group">
                    		...
                    		<input class="form-control" name="base" id="base" type="number" min="3" max="99" value="<?= $base?>" required>
                    		<div class="valid-feedback">Correcto!</div>
                    		<div class="invalid-feedback">Debes introducir un número entre 3 e 99</div>
                    	</div>
                    	<div class="form-group">
                    		<label for="altura">Altura</label>
                    		<input class="form-control" name="altura" id="altura" type="number" min="3" max="99" value="<?= $altura?>" required>
                    		<div class="valid-feedback">Correcto!</div>
                    		<div class="invalid-feedback">Debes introducir un número entre 3 e 99</div>
                    	</div>
