		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                ...
                if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == "1") {
                    ...
                    $num = recolle("numero");
                    if (filter_var($num, FILTER_VALIDATE_INT, ["options" => ["min_range" => 2, "max_range" => 99] ]) === false) {
                ...
                ?>
                    <form class="<?= $error != "" ? 'was-validated':''?>" action="<?= $_SERVER["PHP_SELF"]?>" method="get">
                    	<div class="form-group">
                    		...
                    		<input class="form-control" name="numero" id="numero" type="number" min="2" max="99" value="<?= $num?>" required>
                    		<div class="valid-feedback">Correcto!</div>
                    		<div class="invalid-feedback">Debes introducir un número entre 2 e 99</div>
                    	</div>
