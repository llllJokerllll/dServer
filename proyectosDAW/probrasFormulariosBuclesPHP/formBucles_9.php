    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario Búcles 9</h1>
                
                <?php
                function circulo($cx, $cy, $radio, $color) {
                ...
                if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == "1") {
                    ...
                    $numero = recolle("numero");
                    
                    if (filter_var($numero, FILTER_VALIDATE_INT, ["options" => ["min_range" => 2, "max_range" => 10] ]) === false) {
                    ...
                    if ($error == "") {
                        ...
                        echo "<svg height=\"" . LIENZO . "\" width=\"" . LIENZO . "\">";
                        for($i = 0; $i < $numero; $i++){
                            echo circulo(LIENZO / 2, LIENZO / 2, LIENZO / 2 - $i * ((LIENZO / 2) / $numero), "hsl(".(0 + (315/($numero - 1)) * $i).", 70%, 50%)");
                        }
                ...
                ?>
                    <form class="<?= $error != "" ? 'was-validated':''?>" action="<?= $_SERVER["PHP_SELF"]?>" method="get">
                    	<div class="form-group">
                    		...
                    		<input class="form-control" name="numero" id="numero" type="number" min="2" max="10" value="<?= $numero?>" required>
                    		<div class="valid-feedback">Correcto!</div>
                    		<div class="invalid-feedback">Debes introducir un número entre 2 e 10</div>
                    	</div>
