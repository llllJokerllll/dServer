		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                ...
                if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == "1") {
                    ...
                    $pincel = recolle("pincel");
                    
                    if (filter_var($altura, FILTER_VALIDATE_INT, ["options" => ["min_range" => 4, "max_range" => 80] ]) === false) {
                        $error .= "<br>Número NO válido";
                    }
                    
                    if (filter_var($pincel, FILTER_VALIDATE_REGEXP, ["options" => ["regexp" => "/[*=.-]/"] ]) === false) {
                        $error .= "<br>Pincel NO válido";
                    }
                ...
                ?>
                    <form class="<?= $error != "" ? 'was-validated':''?>" action="<?= $_SERVER["PHP_SELF"]?>" method="get">
                    	<div class="form-group">
                    		...
                    		<input class="form-control" name="altura" id="altura" type="number" min="4" max="80" value="<?= $altura?>" required>
                    		<div class="valid-feedback">Correcto!</div>
                    		<div class="invalid-feedback">Debes introducir un número entre 4 e 80</div>
                    	</div>
                    	<div class="form-group">
                        	<label for="pincel">Pincel</label>
                        	<select class="form-control" id="pincel" name="pincel" required>
