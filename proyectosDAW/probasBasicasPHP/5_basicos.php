		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                ...
                <?php 
                    ...
                    if (($mesN == 12 && $dia >= 22) || ($mesN == 1 && $dia <= 20)) {
                        $signo = "Capricornio";
                    } else if (($mesN == 1 && $dia >= 21) || ($mesN == 2 && $dia <= 18)) {
                        $signo = "Acuario";
                    } else if (($mesN == 2 && $dia >= 19) || ($mesN == 3 && $dia <= 20)) {
                        $signo = "Piscis";
                    } else if (($mesN == 3 && $dia >= 21) || ($mesN == 4 && $dia <= 20)) {
                        $signo = "Aries";
                    } else if (($mesN == 4 && $dia >= 21) || ($mesN == 5 && $dia <= 20)) {
                        $signo = "Tauro";
                    } else if (($mesN == 5 && $dia >= 21) || ($mesN == 6 && $dia <= 21)) {
                        $signo = "Géminis";
                    } else if (($mesN == 6 && $dia >= 22) || ($mesN == 7 && $dia <= 22)) {
                        $signo = "Cancer";
                    } else if (($mesN == 7 && $dia >= 23) || ($mesN == 8 && $dia <= 22)) {
                        $signo = "Leo";
                    } else if (($mesN == 8 && $dia >= 23) || ($mesN == 9 && $dia <= 22)) {
                        $signo = "Virgo";
                    } else if (($mesN == 9 && $dia >= 23) || ($mesN == 10 && $dia <= 21)) {
                        $signo = "Libra";
                    } else if (($mesN == 10 && $dia >= 22) || ($mesN == 11 && $dia <= 21)) {
                        $signo = "Escorpio";
                    } else if (($mesN == 11 && $dia >= 22) || ($mesN == 12 && $dia <= 21)) {
                        $signo = "Sagitario";
                    } else {
                        $signo = "Non válido";
                    }
                    
                    echo "O teu signo do zodíaco é: <strong> " . $signo . "</strong>";
                ?>
