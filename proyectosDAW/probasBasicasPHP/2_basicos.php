		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                ...
                <?php 
                    ...
                    echo "O resultado do cáculo do factorial é: $acumulador<br>";
                    echo "O resultado do cáculo do factorial é: <strong>" . $acumulador ."</strong><br>";
                    echo "O resultado do cáculo do factorial é: <strong>$acumulador</strong>";
                ?>
