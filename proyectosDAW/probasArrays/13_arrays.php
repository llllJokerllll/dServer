    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Array exercicio 13 Linguaxes de Programación</h1>
                
                <?php
                    $xogadores = [
                        ["nome" => "Messi, Lionel","equipo" => "Barcelona", "posicion" => "Dianteiro"],
                        ["nome" => "Ronaldo, Cristiano","equipo" => "Real Madrid", "posicion" => "Dianteiro"],
                        ["nome" => "Aspas, Iago","equipo" => "Celta de vigo", "posicion" => "Dianteiro"],
                        ["nome" => "Neymar","equipo" => "Barcelona", "posicion" => "Dianteiro"],
                        ["nome" => "Negredo, Alvaro","equipo" => "Valencia", "posicion" => "Dianteiro"],
                        ["nome" => "Lux, Germán","equipo" => "Deportivo da Coruña", "posicion" => "Porteiro"],
                        ["nome" => "Williams, Iñaki","equipo" => "Athletic de Bilbao", "posicion" => "Centrocampista"]
                    ];
                    
                    echo "<table>";
                    echo "<tr><th>Nome</th><th>Equipo</th><th>Posición</th></tr>";
                    foreach ($xogadores as $xogador) {
                        echo "<tr><td>" . $xogador['nome'] . "</td><td>" . $xogador["equipo"] . "</td><td>" . $xogador['posicion'] . "</td></tr>";
                    }
                    echo "</table>";
