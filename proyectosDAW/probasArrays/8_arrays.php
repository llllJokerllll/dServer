    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Array exercicio 8 Películas</h1>
                ...
                <?php
                    ...
                    echo "<p>Resumo das péliculas vistas:<br></p>";
                    echo "<table>";
                    echo "<tr><th>Mes</th><th>Nº de péliculas vistas</th></tr>";
                    foreach ($peliculas as $mes => $vistas) {
                        $vistas = ($vistas == 0) ? "Ningunha" : $vistas;
                        echo "<tr><td>" . ucfirst($mes) . "</td><td>$vistas</td></tr>";
                    }
                    echo "</table>";
                ?>
