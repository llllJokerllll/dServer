    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Array exercicio 12 Linguaxes de Programación</h1>
                
                <?php
                    $linguaxes_cliente = [
                        ["Gómez Pérez, Pedro", 25, 350000, "Administrativo"],
                        ["Macías Rodríguez, Antonio", 45, 750000, "Xerente Comercial"],
                        ["Álvarez Chouza, Susana", 37, 1050000, "Xerente RR.HH."],
                        ["Prieto Mosquera, José Luis", 37, 1050000, "Xerente RR.HH."]
                    ];
                    
                    echo "<table>";
                    echo "<tr><th>Nome</th><th>Idade</th><th>Soldo</th><th>Posto</th></tr>";
                    for ($i = 0; $i < count($linguaxes_cliente); $i++) {
                        echo "<tr>";
                        for ($j = 0; $j < count($linguaxes_cliente[$i]); $j++) {
                            echo "<td>" . $linguaxes_cliente[$i][$j] ."</td>";
                        }
                        echo "</tr>";
                    }
                    echo "</table>";
