    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Array exercicio 16 Paises</h1>
                ...
                <?php
                    ...
                    $error = "";
                    $paises = [
                        ["1", "Arxentina", "América", "40.117.096", "2.780.400", ".ar"],
                        ["15", "España", "Europa", "47.190.493", "504645", ".es"],
                        ["48", "Tailandia", "Asia", "65.493.298", "513.115", ".th"],
                        ["11", "Nixeria", "África", "161.644.000", "923.768", ".ng"],
                        ["91", "Nova Zelanda", "Oceanía", "4.306.400", "268.680", ".nz"],
                        ["643", "Rusia", "Asia", "146.267.288", "17.098.242", ".ru"]
                    ];
                    
                    function creaTabla($paises, $id) {
                        foreach ($paises as $pais) {
                            if ($id == $pais[0]) {
                                echo "<tr class='marcado'><td>" . $pais[0] . "</td><td>" . $pais[1] . "</td><td>" . $pais[2] . "</td><td>" . $pais[3] . "</td><td>" . $pais[4] . "</td><td>" . $pais[5] . "</td></tr>";
                            } else {
                                echo "<tr><td>" . $pais[0] . "</td><td>" . $pais[1] . "</td><td>" . $pais[2] . "</td><td>" . $pais[3] . "</td><td>" . $pais[4] . "</td><td>" . $pais[5] . "</td></tr>";
                            }
                        }                       
                        echo "<br>";
                    }
                    ...
                    if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == "1") {
                        ...
                        if (filter_var($id, FILTER_VALIDATE_INT, ["options" => ["min_range" => 1, "max_range" => 645] ]) === false) {
                            $error .= "<br>O ID non é un número válido";
                        }                        
                    }
                ...
                ?>
                <table>
                	<tr><th>ID</th><th>Nome</th><th>Continente</th><th>Poboación</th><th>Superficie</th><th>Dominio de Internet</th></tr>
                	<?= creaTabla($paises, $id)?>
                </table>
                <form action="<?= $_SERVER["PHP_SELF"]?>" method="POST" class="<?= ($error!="")? 'was-validated':''?>">
                	<input class="form" type="number" name="id" value=<?=$id?> minlength="1" maxlength="645">
