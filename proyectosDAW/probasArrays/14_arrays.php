    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Array exercicio 14 Series de Televisión</h1>
                
                <?php
                    $series = [
                        "American Dad" => ["pai" => "Stan", "nai" => "Francine", "fillos" => ["Hayley", "Steve"]],
                        "Padre de familia" => ["pai" => "Peter", "nai" => "Lois", "fillos" => ["Meg", "Chris", "Stewie"]],
                        "Los Simpsons" => ["pai" => "Homer", "nai" => "Marge", "fillos" => ["Bart", "Lisa", "Maggie"]]
                    ];
                    
                    echo "<table>";
                    echo "<tr><th>Serie</th><th>Reparto</th></tr>";
                    foreach ($series as $serie => $reparto) {
                        echo "<tr><td>" . $serie . "</td><td style='text-align: left;'>";
                        echo "<ul>";
                        echo "<li>Pai: <span class='nota'>" . $reparto['pai'] . "</span></li>";
                        echo "<li>Nai: <span class='nota'>" . $reparto['nai'] . "</span></li>";
                        echo "<li>Fillos: <span class='nota'>";
                        foreach ($reparto["fillos"] as $f) {
                            echo $f . ", ";
                        }
                        echo "</span></li></ul></td></tr>";
                    }
                    echo "</table>";
