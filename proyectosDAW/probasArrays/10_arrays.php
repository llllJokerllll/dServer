    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Array exercicio 11 Paises y Presidentes</h1>
                
                <?php
                    $paisesPresidentes = [
                        "España" => "Pedro Sanchez",
                        "Alemania" => "Angela Merkel",
                        "Francia" => "Michel Frederic",
                        "Italia" => "Giuseppe Conte",
                        "Bélgica" => "Sophie Wilmés",
                        "Paises Bajos" => "Mark Rutte",
                        "Reino Unido" => "Boris Johnson",
                        "Rusia" => "Walter Thurnherr",
                        "Portugal" => "António Costa"
                    ];
                    
                    ksort($paisesPresidentes);
                    
                    echo "<ul>";
                    foreach ($paisesPresidentes as $pais => $presidente) {
                        echo "<li>$pais -----> $presidente</li>";
                    }
                    echo "</ul>";
