    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Array exercicio 9 Notas dos Alumnos</h1>
                
                <?php
                    $alumnos = [
                        "Abadín Freire Fernando Manuel" => 9,
                        "Blanco González Jorge" => 3.75,
                        "Calderón Hermida Daniel Sigfredo" => 5,
                        "Gómez lois Adrián" => 3.45,
                        "López Penedo Breixo" => 9.33,
                        "Mesías Díaz Ana" => 7.25,
                        "Pereira Rodríguez José Antonio" => 8.3,
                        "Regueira Padrón Fernando" => 7.4,
                        "Vilar Labarta Javier" => 6,
                        "Villamarín Coello Miguel" => 7
                    ];
                    
                    arsort($alumnos);
                    
                    echo "<p>Notas en IAWEB:</p>";
                    echo "<ol>";
                    foreach ($alumnos as $alumno => $nota) {
                        echo "<li><b>" . $alumno . ":</b><span class ='nota'> $nota</span></li>";
                    }
                    echo "</ol>";
