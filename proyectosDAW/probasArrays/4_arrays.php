		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                ...
                <?php
                    ...
                    echo "<p>Los elementos del array son:<br>";
                    echo var_dump($ventas);
                    echo "</p><br>";
                    
                    echo "<p>La media aritmética es <b>" . number_format(round($media, 3), "2", ",", ".") . "</b></p><br>";
                    echo "<p>Los elementos <b>ordenados</b> del array son:<br>";
                    sort($ventas);
                    echo print_r($ventas);
                    echo "</p><br>";
                ?>
