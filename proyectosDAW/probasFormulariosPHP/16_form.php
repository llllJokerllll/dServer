		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                ...
                if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == 1 ) {
                    ...
                    if ($operacion == "+") {
                        $res = "Suma de $numero1 + $numero2 = " . ($numero1 + $numero2);
                    } else if ($operacion == "*") {
                        $res = "Multiplicación de $numero1 * $numero2 = " . ($numero1 * $numero2);
                    } else if ($operacion == "-") {
                        $res = "Resta de $numero1 - $numero2 = " . ($numero1 - $numero2);
                    } else if ($operacion == "/") {
                        if ($numero2 == 0) {
                            $res = "División por cero non é posible";
                        } else {
                            $res = "División de $numero1 / $numero2 = " . round(($numero1 / $numero2), 2);
                        }
                    ...
                    <input class="form-control" type="number" id="numero1" name="numero1" value="0" min="-999999" max="999999" placeholder="Introduce un número" required/>
                    
                    <label for="numero2">Número2</label>
                    <input class="form-control" type="number" id="numero2" name="numero2" value="0" min="-999999" max="999999" placeholder="Introduce un número" required/>
                    
                    <label for="operacion">Operación</label>
                    <input class="form-control" type="text" id="operacion" name="operacion" value="+" minlength="1" maxlength="1" placeholder="Introduce un símbolo de operación" required pattern="[+-/*]"/>
