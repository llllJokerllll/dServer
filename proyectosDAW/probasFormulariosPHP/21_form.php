        	...
        	<div class="col-md-8 col-lg-9">
                ...
                if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == 1 ) {
                    ...
                    if (!preg_match($pattern, $dni)) {
                        echo "O Dni non ten o formato correcto. 00000000";
                    } else {
                        $dniOk = true;
                    }
                    ...
                    if ($dniOk) {
                        $num = $dni % 23;
                        $res = "A letra do DNI $dni é: $tabla[$num]";
                    ...
                    <input class="form-control" type="number" id="dni" name="dni" value="12345678" min="00000000" max="99999999" required/>
