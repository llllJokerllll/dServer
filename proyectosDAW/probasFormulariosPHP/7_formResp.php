    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 7 Resposta</h1>
                
                <?php 
                
                    //print_r($_REQUEST);
                    $dimension = $_REQUEST["dimension"]; //$_GET["numero1"]; $_POST["numero1"];
                    $grosor = $_REQUEST["grosor"];
                    
                    echo "<p>Dimensión do cadrado: $dimension</p>";
                    echo "<p>Dimensión do grosor: $grosor</p>";
                
                ?>
                <svg width="<?=$dimension ?>" height="<?=$dimension ?>">
                	<rect width="<?=$dimension ?>" height="<?=$dimension ?>" style="fill: white; stroke-width: <?=$grosor ?>; stroke: red;" />
                </svg>
                
                <p><a href="<?= $_SERVER["HTTP_REFERER"]?>" title="Ir para atrás">Volver para atrás</a></p>
