    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 2 Resposta</h1>
                
                <?php 
                
                    //print_r($_REQUEST);
                    $base = $_REQUEST["base"]; //$_GET["numero1"]; $_POST["numero1"];
                    $altura = $_REQUEST["altura"];
                    
                    echo "A área do réctangulo de base $base y altura $altura = <strong>" . $base * $altura . " u^2</strong>";
