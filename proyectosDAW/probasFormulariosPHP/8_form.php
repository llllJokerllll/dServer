    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 8</h1>
                
                <form action="8_formResp.php" method="get">
                
                	<label>Elixe o teu equipo favorito</label><br>
                	
                	<input type="radio" name="equipo" value="Celta de Vigo" required> <label>R.C Celta de Vigo</label><br>
                	<input type="radio" name="equipo" value="R.C Deportivo" required> <label>R.C Deportivo</label><br>
                	<input type="radio" name="equipo" value="Real Madrid" required> <label>Real Madrid</label><br>
                	<input type="radio" name="equipo" value="Barcelona" required> <label>F.C Barcelona</label><br>
                	<input type="radio" name="equipo" value="Athletic" required> <label>Athletic de Bilbao</label><br>
