		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                ...
                if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == 1 ) {
                    ...
                    <input class="form-control" type="number" id="numero" name="numero" value="0" min="-999999" max="999999" placeholder="Introduce un número" required/>
