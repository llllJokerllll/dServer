		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                ...
                if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == 1 ) {
                    ...
                    $promedio = round((($numeroA + $numeroB + $numeroC + $numeroD + $numeroE) / 5), 0);
                    
                    if ($promedio > 10) {
                        echo "O promedio é mayor que 10";
                    } else if ($promedio < 10) {
                        echo "O promedio é menor que 10";
                    } else {
                        echo "O promedio é igual que 10";
                    }
                    ...
                    <label for="numeroA">NúmeroA</label>
                    <input class="form-control" type="number" id="numeroA" name="numeroA" value="0" min="-999999" max="999999" placeholder="Introduce un número" required/>
                    
                    <label for="numeroB">NúmeroB</label>
                    <input class="form-control" type="number" id="numeroB" name="numeroB" value="0" min="-999999" max="999999" placeholder="Introduce un número" required/>
                    
                    <label for="numeroC">NúmeroC</label>
                    <input class="form-control" type="number" id="numeroC" name="numeroC" value="0" min="-999999" max="999999" placeholder="Introduce un número" required/>
                    
                    <label for="numeroD">NúmeroD</label>
                    <input class="form-control" type="number" id="numeroD" name="numeroD" value="0" min="-999999" max="999999" placeholder="Introduce un número" required/>
                    
                    <label for="numeroE">NúmeroE</label>
                    <input class="form-control" type="number" id="numeroE" name="numeroE" value="0" min="-999999" max="999999" placeholder="Introduce un número" required/>
