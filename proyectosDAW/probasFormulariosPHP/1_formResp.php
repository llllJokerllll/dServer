    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 1 Resposta</h1>
                
                <?php 
                
                    //print_r($_REQUEST);
                    $numero1 = $_REQUEST["numero1"]; //$_GET["numero1"]; $_POST["numero1"];
                    $numero2 = $_REQUEST["numero2"];
                    
                    echo "A multiplicación de $numero1 x $numero2 = <strong>" . $numero1 * $numero2 . "</strong>";
