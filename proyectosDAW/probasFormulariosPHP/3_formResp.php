    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 3 Resposta</h1>
                
                <?php 
                
                    //print_r($_REQUEST);
                    $baseImponible = $_REQUEST["baseImponible"]; //$_GET["numero1"]; $_POST["numero1"];
                    $tipoIVE = $_REQUEST["tipoIVE"];
                    $cantidadeIVE = round($baseImponible * $tipoIVE / 100, 2);
                    $total = $baseImponible + $cantidadeIVE;
                    
                    echo "
                        <table style='border: 1px solid black;'>
                            <tr>
                                <th>Base Impoñible</th>
                                <th>Tipo de IVE</th>
                                <th>IVE</th>
                                <th>Total</th>
                            </tr>
