    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 3</h1>
                
                <form action="3_formResp.php" method="get">
                
                	<label>Base impoñible</label>
                	<input class="form-control" type="number" name="baseImponible" min="0" step="0.01" max="1000" value="1" required placeholder="Introduzca un número">
                	
                	<label>Tipo IVE</label>
                	<select class="form-control" name="tipoIVE" required>
