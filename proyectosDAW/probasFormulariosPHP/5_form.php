    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 5</h1>
                
                <form action="5_formResp.php" method="get">
                
                	<label>MegaBytes</label>
                	<input class="form-control" type="number" name="megabytes" min="0" step="0.01" max="9999999" value="1" required placeholder="Introduzca un número">
