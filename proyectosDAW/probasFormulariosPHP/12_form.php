		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                ...
                if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == 1 ) {
                    ...
                    if ($numeroA > $numeroB) {
                        echo "El resultado de la suma de $numeroA y $numeroB es: " . ($numeroA + $numeroB);
                    } else {
                        echo "El resultado del producto de $numeroA y $numeroB es: " . ($numeroA * $numeroB);
                    }
