        	...
        	<div class="col-md-8 col-lg-9">
                ...
                if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == 1 ) {
                    ...
                    if (!preg_match($pattern, $hora)) {
                        echo "Formato de hora non válida. HH:MM:SS";
                    } else {
                        $horaOk = true;
                    }
                    
                    if ($horaOk) {
                        $tiempo = preg_split("/:/", $hora);
                        $horas = 23 - $tiempo[0];
                        $mins = 59 - $tiempo[1];
                        $secs = 59 - $tiempo[2];
                        
                        $res = "Faltan " . $horas . ":" . $mins . ":" . $secs;
                        echo $res;
                    ...
                    <div class="form-group">
                    	...
                    	<input class="form-control" type="time" id="hora" name="hora" value="08:15:30" required/>
