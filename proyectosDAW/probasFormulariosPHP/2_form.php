    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 2</h1>
                
                <form action="2_formResp.php" method="get">
                
                	<label>Base</label>
                	<input class="form-control" type="number" name="base" min="1" max="100" value="1" required placeholder="Introduzca un número">
                	
                	<label>Altura</label>
                	<input class="form-control" type="number" name="altura" min="1" max="100" value="1" required placeholder="Introduzca un número">
