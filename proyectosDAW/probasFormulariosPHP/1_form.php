    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 1</h1>
                
                <form action="1_formResp.php" method="get">
                
                	<label>Número 1</label>
                	<input class="form-control" type="number" name="numero1" min="-99" max="999999" value="0" required placeholder="Mete un número">
                	
                	<label>Número 2</label>
                	<input class="form-control" type="number" name="numero2" min="-99" max="999999" value="0" required>
