        	...
        	<div class="col-md-8 col-lg-9">
                ...
                if (isset($_REQUEST["envio"]) && $_REQUEST["envio"] == 1 ) {
                    ...
                    if (($ano % 4 == 0 && $ano % 100 != 0) || $ano % 400 == 0) {
                        $res = "O ano $ano é bisiesto";
                    } else {
                        $res = "O ano $ano NON é bisiesto";
                    }
                    ...
                    <input class="form-control" type="number" id="ano" name="ano" value="0" min="0" max="9999" placeholder="Introduce un Ano" required/>
