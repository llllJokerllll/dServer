    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 7</h1>
                
                <form action="7_formResp.php" method="post">
                
                	<label>Dimensión do cadrado</label>
                	<input class="form-control" type="number" name="dimension" min="0" step="1" max="500" value="1" required placeholder="Introduzca un número">
                	
                	<label>Dimensión do grosor</label>
                	<input class="form-control" type="number" name="grosor" min="1" step="1" max="50" value="1" required placeholder="Introduzca un número">
