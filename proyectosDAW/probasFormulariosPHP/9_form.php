    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 9</h1>
                
                <form action="9_formResp.php" method="get">
                
                	<label>Elixe o teu equipo favorito</label><br>
                	
                	<input type="radio" name="equipo" value="celta.png" required> <label>R.C Celta de Vigo</label><br>
                	<input type="radio" name="equipo" value="deportivo.png" required> <label>R.C Deportivo</label><br>
                	<input type="radio" name="equipo" value="madrid.png" required> <label>Real Madrid</label><br>
                	<input type="radio" name="equipo" value="barsa.png" required> <label>F.C Barcelona</label><br>
                	<input type="radio" name="equipo" value="athletic.png" required> <label>Athletic de Bilbao</label><br>
