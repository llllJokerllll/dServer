    ...
    <div class="container-fluid">
		...
		<div class="row mb-5">
        	...
        	<div class="col-md-8 col-lg-9">
                <h1>Formulario exercicio 10</h1>
                
                <form action="10_formResp.php" method="get">
                
                	<label>Cor do fondo da páxina</label>
                	<input class="form-control" type="color" name="fondo" value="#f0fff0" required/>
                	
                	<label>Cor da letra da páxina</label>
                	<input class="form-control" type="color" name="letra" value="#000000" required/>
